...
The R code "PhyloMixedModelRevisions.clock.R" should be used with data file "spillover.blocks.csv" for the analysis of our spillover data.
The R code "PhyloMixedModelTransmissionRevisions.R" should be used with the data file "TransmissionData.csv" for the analysis of transmission following spillover.
